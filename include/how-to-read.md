...
I start with the core protocol: what a token is, how keys work, and how a mint describes itself. Then I walk through the three operations every wallet cares about: mint, melt, and swap. A shared error table sits at the end of that chapter; later NUTs keep linking to it. After that come wallet state, spending conditions, Lightning and other payment methods, payment requests, realtime and auth, and a small Nostr chapter.
